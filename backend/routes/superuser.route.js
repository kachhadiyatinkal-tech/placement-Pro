...
const { setUserActiveStatus, setCompanyActiveStatus, updateUserDetails, updateCompanyDetails } = require('../controllers/SuperUser/user-status.controller.js');
...
router.post('/user-set-active', authenticateToken, setUserActiveStatus);
router.post('/company-set-active', authenticateToken, setCompanyActiveStatus);
router.post('/user-update', authenticateToken, updateUserDetails);
router.post('/company-update', authenticateToken, updateCompanyDetails);
