...
const uploadNoticeAttachments = require('../config/MulterNoticeAttachment');
...
const { SendNotice, GetAllNotice, DeleteNotice, GetNotice, GetNoticesByReceiver, UpdateNotice } = require('../controllers/Management/notice.controller');
...
router.post('/send-notice', authenticateToken, uploadNoticeAttachments.array('attachments', 5), SendNotice);

router.get('/get-all-notices', authenticateToken, GetAllNotice);

router.get('/get-notices', authenticateToken, GetNoticesByReceiver);
